...
#while varying the predictor variables with include =
#You can also look at one predictor across several outcomes.
...
linear_model <- lm(glasses ~ eyesight_cat + sex_cat,
									 data = nlsy)
linear_model_int <- lm(glasses ~ eyesight_cat + sex_cat,
											 data = nlsy)
